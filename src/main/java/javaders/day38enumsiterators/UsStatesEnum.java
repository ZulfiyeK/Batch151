...
public enum UsStatesEnum {
    //degisme ihtimali olamayan datalari depolamak icin kullanilir. mesela gunlrin isimleri, ay isimleri, amerikadaki eyalet isimleri..vb
    //standalone==> application'lar boyle olmalidir, kendi baslarina ayakta durabilirler. degismez sabit tadalar buyuk harfle yazilir.
    ...
    private final String stateName;//sabit degismeyen data oldugu icin final
    private final String abbreviation;
    private final String capital;

    UsStatesEnum(String stateName, String abbreviation, String capital) {// contructor olusturduk sag tik generate,contructor.
    ...
    public static String getAbbreviationForStateName(String stateName) {// static yaptik cunku enum ismi ile cagiriyoruz.
        return Arrays.stream(values())
