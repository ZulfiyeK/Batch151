...
public class IncrementDecrement {
    ...
    /*
         int age= 12; bunu bir arttirmak icin
         age=age+1; deriz. ama java da tekrar seviomedigi icin; " age+=1; "yada " age++; " seklinde yazariz.
         Ama age++; burda sayi olmadigi icin bu sadece bir arttirir. Burda hep toplama oldugu icin buna " arttirmak "
         yani INCREMENT denir.
