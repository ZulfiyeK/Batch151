...
public class StaticNonStaticBlocks01 {
   ...
   /*
     ...
     */
        ...
        //static olanlar class'a baglidir, beraber yaratilirlar.static variable olusturdugumuzda static variable'lerde olusturulur, bir butun halindedirler.
        //class'a sahip oldugumuz anda pi sayisina da, price'a da sahibiz. birlikte glirler.

        //neden main icinde degilde block icinde yaziyoruz; static block'lar static oldugu icin class olusturulurken class'a monte edilir, mainden once calistirilir.'
