package practicessulehoca.day02;
    ...
    public static String enUzunPalindrome(String str) {
        ...
        for (int i = 0;   i <str.length() ;    i++) {
            for (int j = i+1; j <= str.length(); j++) {// "hellosannasmith";
                ...
                String currentString = str.substring(i,j);//currentString=gecerliString- 0 ile 1 deki indeksleri al ve bu konteynira yerlestir.
