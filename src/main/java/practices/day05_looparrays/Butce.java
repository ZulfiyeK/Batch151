...
public class Butce {
 ...
 // Tum aile uyelerinin birikiminin bulundugu ortak ihtiyaclar icin kullanildigi bir butce ile
 // kisisel harcamalarin yapildigi harclik'larin oldugu basit bir ev bütçesi kodu yazınız.
