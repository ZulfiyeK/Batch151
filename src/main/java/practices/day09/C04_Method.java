...
public class C04_Method {
    ...
    public static void dogrucevapsayisi(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i < answers.length; i++) {// 0 dan ogrenci sayisina kadar donguye aldik
            ...
            int sayac = 0;//  her ogrenciden sonra sayac sifirlanmasi lazim, bu yuzden for icine yazmadik.

            for (int j = 0; j <answers[i].length ; j++) {// 0 dan ogrencinin cevap sayisina(bir ogrencinin) kadar donguye aliyoruz.
                if(answers[i][j] == keys[j]){// ogrencinin cevabi, cevap anahtarina esit mi diye bakiyoruz.
                   sayac++; //ogrencinin cevabi, cevap anahtarina esit ise sayac bir artar
                }
            }
            System.out.println(i+1+ "nolu ogrencinin dogru cevap sayisi: " + sayac);
            /*
            1nolu ogrencinin dogru cevap sayisi: 7
            2nolu ogrencinin dogru cevap sayisi: 6
            3nolu ogrencinin dogru cevap sayisi: 5
            4nolu ogrencinin dogru cevap sayisi: 4
            5nolu ogrencinin dogru cevap sayisi: 8
            6nolu ogrencinin dogru cevap sayisi: 7
            7nolu ogrencinin dogru cevap sayisi: 7
            8nolu ogrencinin dogru cevap sayisi: 7 */
